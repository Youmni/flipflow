...
const Documentation = () => {
  return (
    <>
      <Helmet>
        <title>FlipFlow - Documentation</title>
      </Helmet>
    ...
    "message": "There was an error signing up"
            ...
            <section className="space-y-4">
              ...
              <p className="text-gray-600">
                <strong>Purpose:</strong> Allows a user to get a new access
                token and refresh token using a valid refresh token.
              </p>
              <p className="text-gray-600">
                <strong>Method:</strong> POST
              </p>
    ...
    "message": "Invalid refresh token"
          ...
          <section id="user" className="space-y-4">
            ...
            <section className="space-y-4">
              ...
              <p className="text-gray-600">
                <strong>Authentication:</strong> None (No access token
                required).
              </p>
              <p className="text-gray-600">
...
const schema = Joi.object({
    ...
    "message": "User not found"
              ...
              <p className="text-sm text-red-600">
                <strong>401 Unauthorized:</strong> If the authentication token
                is invalid.
              </p>
              <pre className="bg-gray-100 p-4 rounded-md text-sm text-gray-700">
                {`{
    "message": "Invalid token"
            ...
            <section className="space-y-4">
              ...
              <p className="text-gray-600">
                <strong>Purpose:</strong> Updates the password of a specific
                user by their ID.
              </p>
              <p className="text-gray-600">
...
const schema = Joi.object({
  ...
  "card": {
      ...
      "answer": "Sample answer."
              ...
              <p className="text-sm text-red-600">
                <strong>404 Not Found:</strong> If the card set with the given
                ID does not exist.
              </p>
              <pre className="bg-gray-100 p-4 rounded-md text-sm text-gray-700">
                {`{
  ...
  "message": "Card set not found."
            ...
            <section className="space-y-4">
              ...
              <p className="text-gray-600">
                <strong>Purpose:</strong> Deletes an existing card from a
                specific card set.
              </p>
              <p className="text-gray-600">
                <strong>Method:</strong> DELETE
  ...
  "visibility": "public"
              ...
              <section className="space-y-4 mt-6">
                ...
                <p className="text-gray-600">
                  The request body is validated using the following schema
                  (card_set_id is not required for creating a card set):
                </p>
                <pre className="bg-gray-100 p-4 rounded-md text-sm text-gray-700">
                  {`
  const schema = Joi.object({
  ...
  "message": "Card set not found."
            ...
            <section className="space-y-4">
              ...
              <ul className="text-gray-600 list-disc pl-5">
                ...
                <li>
                  <code>search</code> (optional): Keyword to filter the card
                  sets by title or description.
                </li>
              </ul>
  ...
  "message": "User not found."
            ...
            <section className="space-y-4">
              ...
              <p className="text-gray-600">
                <strong>Purpose:</strong> Retrieves a specific card set along
                with its cards.
              </p>
              <p className="text-gray-600">
                <strong>Method:</strong> GET
